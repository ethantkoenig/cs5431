...
\subsection{Confidentiality - cryptocurrency}
...
\subsection{Confidentiality - wallet app}
...
\subsection{Integrity - cryptocurrency}
...
\subsection{Integrity - wallet app}
...
\subsection{Authorization - cryptocurrency}
\begin{itemize}
...
\subsection{Authorization - wallet app}
...
\subsection{Audit - cryptocurrency}
...
\subsection{Audit - wallet app}

\begin{itemize}
	\item We log all requests and transactions made via the web application.
	This log enables us to detect if a user's funds are illicitly spent.
	Unfortunately, the decentralized nature of the underlying cryptocurrency will prevent us from undoing fraudulent transactions.
	\item We are also recording failed login attempts, so that administrators can review and assess online guessing attacks.
\end{itemize}
