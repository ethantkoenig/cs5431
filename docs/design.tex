...
<<<<<<< 9280f6f56f1fd93e81eec27639b2142b6657273f
...
=======
Each completed block is written to a file which makes the audit and reconstruction of the blockchain possible should a new node enter the network. We are considering using a database for storing the blockchain next sprint.
>>>>>>> Comment about using database for persisting blockchain
\end{itemize}
