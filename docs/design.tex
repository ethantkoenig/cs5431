...
/% from here to the end of the section needs revision, we should make it clear what is implemented and what will be implemented
...
/% I believe the following it changeed from one time link, to visit the password reset page to get a one time link (?)
